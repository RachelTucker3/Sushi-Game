...
public class ConsumedScoreboardWidget extends JPanel implements BeltObserver {

	private SushiGameModel game_model;
	private JLabel display;
	
	public ConsumedScoreboardWidget(SushiGameModel gm) {
		game_model = gm;
	...
	private String makeScoreboardHTML() {
		...
		for (Chef c : chefs) {
			sb_html += c.getName() + ": " + Math.round(c.getAmountConsumed()*100.0)/100.0 + " <br>";
		}
		return sb_html;
	}
